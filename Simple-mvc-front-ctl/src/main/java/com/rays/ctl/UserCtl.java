...
public class UserCtl {
	...
	@PostMapping
	public String signUp(@ModelAttribute("form") @Valid UserForm form,BindingResult bindingResult, Model model,
		...
		if (id != null && id > 0) {
			...
			try {
				...
				e.printStackTrace();
				model.addAttribute("msg", "User alrady exist");
			}
		}
